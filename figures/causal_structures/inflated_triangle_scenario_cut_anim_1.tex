...
\begin{tikzpicture}[scale=2]
    \begin{scope}[every node/.style=observed, onslide=<2->{fade}]
        ...
        \node[onslide=<2->{unfade}] (A1) at (0, {2*sqrt(3) - 2*2/sqrt(3)*(1/\ift)}) {$A_1$};
    \end{scope}
    \begin{scope}[every node/.style=latent, onslide=<2->{fade}]
        \node[onslide=<2->{unfade}] (X1) at ({-1 + 1/\ift}, {sqrt(3) - 1/(\ift*sqrt(3))}) {$X_1$};
        \node[onslide=<2->{unfade}] (Y2) at (1, {sqrt(3)}) {$Y_2$};
        \node[onslide=<2->{unfade}] (Y1) at ({1 - 1/\ift}, {sqrt(3) - 1/(\ift*sqrt(3))}) {$Y_1$};
        \node[onslide=<2->{unfade}] (Z1) at (0, 0.5) {$Z_1$};
    \end{scope}
